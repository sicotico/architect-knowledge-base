...
> **Pregunta original:**
> 
para acotar codex , hay que ejecutarlo dentro del proyecto de tabbyAPI no  ?
> Tengo el servidor de Ubuntu 26.04 LTS Server con TabbyAPI sobre uv con python 3.13. Merece la pena instalar codex en el servidor o desde un cliente puedo administrarlo comodamente  
> en ubuntu  
> 
